          ...
          {[
            ...
            <div className="group flex flex-col justify-center" key={index}>
              {card.map(({ jobTitle, pfp, fullName, review }, index) => (
                <div
                  className="bg-dark border-darker shadow-baseDarker mb-4 min-h-48 w-full rounded-base border-2 p-5 lg:mb-8 w900:mx-auto w900:min-h-20 w900:w-2/3 w500:w-full"
                  key={index}
                >
